...
relpath_to_reach_sndfile_src_from_our_output_dir = '../../../build_oss_deps/mac/cedrus_build_snd_and_paudio/libsndfile-1.0.28/'

flac_inc_dir = os.path.abspath(
    os.getcwd() +
    '/cedrus_build_snd_and_paudio/flac_ogg_vorbis_from_homebrew/flac/1.3.3/include')
flac_lib_dir = os.path.abspath(
    os.getcwd() +
    '/cedrus_build_snd_and_paudio/flac_ogg_vorbis_from_homebrew/flac/1.3.3/lib')

ogg_inc_dir = os.path.abspath(
    os.getcwd() +
    '/cedrus_build_snd_and_paudio/flac_ogg_vorbis_from_homebrew/libogg/1.3.4/include')
ogg_lib_dir = os.path.abspath(
    os.getcwd() +
    '/cedrus_build_snd_and_paudio/flac_ogg_vorbis_from_homebrew/libogg/1.3.4/lib')
