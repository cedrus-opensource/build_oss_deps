...
//
// $Id: InitWxGuiTestSetUp.cpp 69 2008-01-24 21:16:37Z john $
///////////////////////////////////////////////////////////////////////////////
...
//   Cedrus commenting. Commenting OUT the following "extern int". (the #include for init.h should suffice)
...
void InitWxGuiTestSetUp::setUp ()
{
    ...
    #else
        int argc = 1;
        char *argv[1] = {"wxGuiTest_Record_And_Playback_Application"}; // This string is used by wxApp and returned from wxAppConsole::GetAppName
        ::wxEntry (argc, argv);
    #endif
